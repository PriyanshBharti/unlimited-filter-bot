...
@zautekm.on_message(filters.command('id') & (filters.private | filters.group))
...
@zautekm.on_message(filters.command('info') & (filters.private | filters.group))
...
@zautekm.on_message((filters.private | filters.group) & filters.command('status'))
